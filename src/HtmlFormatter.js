...
class HtmlFormatter extends Formatter {
    ...
    format(result, errorsOnly){
        ...
        let htmlText = '<table>\n' +
                       ...
                       '<tr><td style="padding-left:8px;' + cellBackground + '">key</td><td style="'+ cellBackground + 'padding-left:8px;padding-right:30px">' + result.id + '</td></tr>\n' +
                       '<tr><td style="padding-left:8px;'+ cellBackground + '">source</td><td style="'+ cellBackground+ 'padding-left:8px;padding-right:30px">' + result.source + '</td></tr>\n' +
