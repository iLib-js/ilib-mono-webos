...
### Options
- -i, --inputPath
  Base directory containing input XLIFF files. (required)
- -o, --outputPath
  Directory where processed XLIFF files will be written. (required)
- -c, --criteria
  loctool select criteria string. (mutually exclusive with --criteriaFile)
- -f, --criteriaFile
  Excel file (.xlsx) used to generate criteria list. (mutually exclusive with --criteria)
- --dry-run
  Do not execute loctool. Only print planned commands.
